...
<div class="cadre">
    ...
    <div class="interieur_cadre">
        <form action="traitementpassword.php" method="post" id="connexion">
            ...
            <input type="password" class="form-control" name="mot_de_passe" id="inputPassword2"
                   placeholder="Mot de passe" required="required" autofocus
                   data-validation-required-message="Entrer un mot de passe pour accéder au site."/>
